...
function initLanguageToggle() {
    ...
    const translations = {
        en: {
            ...
            'pham-research': 'Research Focus: AI Language Assessment (IELTS Grading), Cross-Lingual Patent Analysis, Vietnamese Linguistics',
        ...
        zh: {
            ...
            'pham-research': '研究方向：AI語言評估（雅思評分）、跨語言專利分析、越南語語言學',
