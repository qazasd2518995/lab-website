...
function initLanguageToggle() {
    ...
    const translations = {
        en: {
            ...
            'leadership-title': 'Lab Directors',
            ...
            'tag-tesol': 'TESOL',
            'tag-sla': 'Second Language Acquisition',
            'tag-anxiety': 'Language Learning Anxiety',
            'tag-strategies': 'Learning Strategies',
            'tag-individual': 'Individual Differences',
            'codirector-office': 'Office: Room 503, Humanities Building, NTOU',
            'codirector-phone': 'Phone: (02) 2462-2192 ext. 2003',
            'codirector-email': 'Email: tyhsiao@mail.ntou.edu.tw',
            ...
            'cheng-research': 'Research Focus: Computational Linguistics, Data and Text Mining, App Development, Chatbot',
            ...
            'pham-name': 'Pham, Huy Hoang',
            'pham-position': 'Research Assistant, National Taiwan University of Science and Technology',
            'pham-research': 'Research Focus: Applied Linguistics, AI Language Assessment (IELTS Grading), Cross-Lingual Patent Analysis, Vietnamese Linguistics',
            'tag-applied-ling': 'Applied Linguistics',
            'tag-ai-assessment': 'AI Assessment',
            'tag-patent': 'Patent Analysis',
            'tag-academic-research': 'Academic Research',
            'tag-text-mining': 'Text Mining',
        ...
        zh: {
            ...
            'codirector-name': '蕭聰淵 教授',
            'codirector-title': '共同主持人',
            'codirector-edu': '美國德州大學奧斯汀校區外語教育博士',
            'tag-tesol': '英語教學',
            'tag-sla': '第二語言習得',
            'tag-anxiety': '語言學習焦慮',
            'tag-strategies': '學習策略',
            'tag-individual': '個別差異測量',
            'codirector-office': '辦公室：海洋大學人文大樓503室',
            'codirector-phone': '電話：(02) 2462-2192 分機 2003',
            'codirector-email': '電子郵件：tyhsiao@mail.ntou.edu.tw',
            ...
            'cheng-research': '研究方向：計算語言學、資料與文本探勘、應用程式開發、聊天機器人',
            ...
            'tag-pedagogy': '語言教學',
            'pham-name': '范輝璜',
            'pham-position': '研究助理，國立臺灣科技大學',
            'pham-research': '研究方向：應用語言學、AI語言評估（雅思評分）、跨語言專利分析、越南語語言學',
            'tag-applied-ling': '應用語言學',
            'tag-ai-assessment': 'AI評估',
            'tag-patent': '專利分析',
            'tag-academic-research': '學術研究',
            'tag-text-mining': '文本探勘',
