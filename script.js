...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animatedElements = document.querySelectorAll('.research-card, .member-card, .highlight-item, .publication-item');
    ...
    const memberCards = document.querySelectorAll('.member-card:not(.placeholder)');
    ...
    // Data visualization animation enhancement
    ...
    publicationLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            if (this.getAttribute('href') === '#') {
                e.preventDefault();
                showNotification('Publication link will be available soon.', 'info');
            }
        });
    });
    ...
    scrollToTopBtn.addEventListener('mouseenter', function() {
        ...
        this.style.boxShadow = '0 6px 16px rgba(21, 101, 192, 0.4)';
    });
